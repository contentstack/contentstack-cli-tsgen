    ...
    async run() {
        try {
            ...
            if (flags.graphql) {
                ...
                await fs_1.promises.writeFile('./codegen.yml', YAML.stringify(codegenConfig));
                ...
                await fs_1.promises.writeFile('./graphql-sdl.graphql', pSchema);
                let generateTypes = (0, child_process_1.spawn)('npm', ['run', 'generate-types']);
